...
import { abi as PAIR_V2_ABI } from '@ekawibisono/v2-core/build/ONLYV2Pair.json'
...
describe('V3Migrator', () => {
  ...
  let factoryV3: IONLYV3Factory
  let token: TestERC20
  let weth9: IWETH9
  let nft: MockTimeNonfungiblePositionManager
  let migrator: V3Migrator
  let pair: IONLYV2Pair
  ...
  describe('#migrate', () => {
    ...
    beforeEach('add V2 liquidity', async () => {
      ...
      pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IONLYV2Pair
